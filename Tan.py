        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["me","คท","Me",".คท","!me","/me"]:
                    line.sendText(msg.to,"อีดอกเช็คทั้งวันทั้งคืนเลยหรอ555")
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ เจไลค์เลย👍")
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"กูว่ามึงอาการหนักนะเนี๊ยะ!!. อิอิ😝😝")				
